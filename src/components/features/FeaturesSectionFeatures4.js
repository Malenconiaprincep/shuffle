...
export default function FeaturesSectionFeatures4() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap xl:items-center -m-8">
      ...
      <div className="w-full md:w-1/2 p-8">
        <div className="max-w-max mx-auto overflow-hidden rounded-4xl">
          <img className="transform hover:scale-105 transition ease-in-out duration-1000" src="flaro-assets/images/features/card.png" alt="" />
        </div>
      </div>
    </div>
  </div>
